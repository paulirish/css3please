...
.box_rotate {
  ...
  -webkit-transform: rotate(<b g="0">7.5</b>deg);  <span class="comment">/* Saf3.1+, Chrome <span class="endcomment">*/</span></span>
         ...
         -ms-filter: <span class="msFilter">"progid:DXImageTransform.Microsoft.Matrix(
                      <b g="0" i="matrix2deg" o="deg2matrix" readonly>M11=0.9914448613738104, M12=-0.13052619222005157, M21=0.13052619222005157, M22=0.9914448613738104</b>, 
                      sizingMethod='auto expand')"</span>; <span class="comment">/* IE8 <span class="endcomment">*/</span></span></span>
               zoom: 1;
}</pre>
  <pre class="rule comment commentclose"><span class="comment">/* */</span></pre>
</div>
...
<div id="box_transition" class="rule_wrapper ">
  ...
  <pre class="rule">
.box_transition {
     -moz-transition: <b g="0">all</b> <b g="1">0.3s</b> <b g="2">ease-out</b>;  <span class="comment">/* FF3.7+ <span class="endcomment">*/</span></span>
